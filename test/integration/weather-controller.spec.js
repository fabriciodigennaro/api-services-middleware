...
const { apiResponseOk, apiNotFoundResponse } = require("../mocks/integration/api-weather-response.mock.js");
...
describe('Weather controller integration tests', () => {
    ...
    it("GET /weather response validation Error empty string", (done) => {
        ...
        .query(
          ...
          .end((err, res) => {
            ...
            expect(res).be.not.null;
            expect(res).be.not.undefined;
            expect(res.body.message).to.equal("City query param is required");
